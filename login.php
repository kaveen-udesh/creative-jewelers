...
if(isset($_POST['btnLogin'])){
	...
	$sql = "SELECT * FROM users WHERE email='".$email."' AND password='".$pass."' AND user_type='Customer'";
...
<div style="padding-top:76px;" align="center" ;>
    ...
    <div class="container" style="padding-top: 50px; padding-bottom: 80px;">
        <div class="row">
            ...
            <div class="col">
                <h1 style="color:#00dda8; padding-top: 150px; padding-bottom: 30px;"><b>USER LOGIN</b></h1>
                <form class="validation" novalidate action="login.php" method="post">
                    ...
                    <button type="submit" id="btn2" class="btn" name="btnLogin"><i class="fas fa-sign-in-alt"
                            style="padding-right: 10px;"></i>LOGIN</button>
                </form><br />
