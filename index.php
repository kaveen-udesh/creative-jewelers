    ...
    <div style="background-color:#f2f2f2;">
        ...
        <div class="row no-gutters">
            <div class="col-sm" style="padding:25px;">
                <a href="jewellery.php?page=ladies_jewellery"><img class="img1" src="assets/images/ladies.jpg" /></a><br /><br />
                <h3>LADIES</h3>
            ...
            <div class="col-sm" style="padding:25px;">
                <a href="jewellery.php?page=gens_jewellery"><img class="img1" src="assets/images/gens.jpg" /></a><br /><br />
                <h3>GENTS</h3>
            ...
            <div class="col-sm" style="padding:25px;">
                <a href="jewellery.php?page=kids_jewellery"><img class="img1" src="assets/images/kids.jpg" /></a><br /><br />
                <h3>KIDS</h3>
    ...
    <div style="text-align:center;">
        <div style="padding-top: 30px; padding-bottom: 30px;">
            <h2>CONNECT WITH US</h3>
                <a href="#"><img class="img2" src="assets/images/Social media/facebook.png" alt="Facebook"
                        style="margin: 15px;"></a>
                <a href="#"><img class="img2" src="assets/images/Social media/instagram.png" alt="Instagram"
                        style="margin: 15px;"></a>
                <a href="#"><img class="img2" src="assets/images/Social media/twitter.png" alt="Twitter"
                        style="margin: 15px;"></a>
                <a href="#"><img class="img2" src="assets/images/Social media/linkedIn.png" alt="LinkedIn"
                        style="margin: 15px;"></a>
        </div>
    </div>
