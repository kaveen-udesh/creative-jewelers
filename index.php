    ...
    <div id="Slideshow" class="carousel slide offset-xl-0 col-xl-12" data-ride="carousel" data-interval="2000">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="assets/images/1.png" alt="Boomerang" class="d-block w-100" />
            </div>

            <div class="carousel-item">
                <img src="assets/images/3.png" alt="Shockwave" class="d-block w-100" />
            </div>

            <div class="carousel-item">
                <img src="assets/images/4.png" alt="Kiddies pool" class="d-block w-100" />
            </div>

            <div class="carousel-item">
                <img src="assets/images/3.png" alt="The claw" class="d-block w-100" />
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <p>Creative Jewelers has proven its reliability through 5 decades of serving you. Creative Jewelers
                    ...
                    with you forever.Best Jeweller in Sri Lanka.</p><br />
                <button type="button" id="btn1" class="btn">Discover
                    More</button>
            </div>
        </div>
    </div>
    ...
    <div style="text-align:center;">
        <div style="padding-top: 30px; padding-bottom: 30px;">
            <h2>CONNECT WITH US</h3>
                <a href="#"><img src="assets/images/Social media/facebook.png" alt="Facebook" width="50" height="50"
                        style="margin: 15px;"></a>
                <a href="#"><img src="assets/images/Social media/instagram.png" alt="Instagram" width="50" height="50"
                        style="margin: 15px;"></a>
                <a href="#"><img src="assets/images/Social media/twitter.png" alt="Twitter" width="50" height="50"
                        style="margin: 15px;"></a>
                <a href="#"><img src="assets/images/Social media/linkedIn.png" alt="LinkedIn" width="50" height="50"
                        style="margin: 15px;"></a>
        </div>
    </div>
